...
$SERVICE_FIELDS = array("date_inscription", "saisons", "date_affiliation_envoye", "carte_judoca_recu", "sans_affiliation", "affiliation_initiation", "affiliation_ecole", "affiliation_parascolaire", "cours", "no_sessions", "passeport", "resident", "paypal", "judogi", "escompte", "categorie_frais", "affiliation_frais", "supp_frais", "frais", "cas_special_note", "escompte_special", "affiliation_envoye", "solde", "club_id", "nom_tarif_id");
$PAYMENT_FIELDS = array("number", "mode", "chqno", "paiement_date", "montant");
